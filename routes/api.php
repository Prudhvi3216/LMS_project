...
Route::group(['prefix'=>'instructor', 'middleware'=>'auth:api'], function() {
  ...
  Route::delete('/delete-course-thumbnail/{course_id}', 'fileUploadController@delete_course_thumbnail');
  Route::delete('/delete-course-image/{course_id}', 'fileUploadController@delete_course_image');
  Route::delete('/delete-course-promo/{course_id}', 'fileUploadController@delete_course_promo');
